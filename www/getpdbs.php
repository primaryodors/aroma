...
foreach ($prots as $protid => $p)
{
    ...
    switch ($source)
    {
        ...
        $url = "https://alphafold.ebi.ac.uk/files/AF-$uid-F1-model_v6.pdb";
        break;
...
LOAD $infname
REMARK   1
REMARK   1 This file has been modified for AromaDock compatibility.
REMARK   1
REMARK 600
$rgns
UPRIGHT
...
heredoc;
    ...
    $scriptname = "tmp/get.phew";
    $fp = fopen($scriptname, "wb") or die("FAILED to open $scriptname for writing.\n");
    fwrite($fp, $editf);
    fclose($fp);

    passthru("bin/phew $scriptname");
