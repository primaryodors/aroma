...
class Interaction
{
    ...
    bool accept_change(Interaction relative_to);
};
...
public:
    ...
    static float potential_binding(Atom* a, Atom* b, bool subtract_hydrophilicty_mismatches = true);
...
protected:
    ...
    static Interaction add_clashes(Atom* a, Atom* b, Interaction kJmol, float r, float rbind);
...
extern bool only_closest_conj_charge;
