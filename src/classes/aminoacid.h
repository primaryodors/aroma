...
public:
    ...
    void conform_atom_to_location(int atom_idx, Point target, int iterations = 50, float optimal_distance = 0, bool ignore_mclashables = false);
    void conform_atom_to_location(const char* atom_name, Point target, int iterations = 20, float optimal_distance = 0, bool ignore_mclashables = false);
    void conform_atom_to_location(Atom* a, Atom* target, int iterations = 50, float optimal_distance = 0, bool ignore_mclashables = false);
